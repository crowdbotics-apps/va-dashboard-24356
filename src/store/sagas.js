...
function* api_v1_contract_listWorker(action) {
  try {
    const result = yield call(apiService.api_v1_contract_list, action)
    yield put(actions.api_v1_contract_listSucceeded(result, action))
  } catch (err) {
    yield put(actions.api_v1_contract_listFailed(err, action))
  }
}
function* api_v1_contract_listWatcher() {
  yield takeEvery(types.API_V1_CONTRACT_LIST, api_v1_contract_listWorker)
}
function* api_v1_contract_createWorker(action) {
  try {
    const result = yield call(apiService.api_v1_contract_create, action)
    yield put(actions.api_v1_contract_createSucceeded(result, action))
  } catch (err) {
    yield put(actions.api_v1_contract_createFailed(err, action))
  }
}
function* api_v1_contract_createWatcher() {
  yield takeEvery(types.API_V1_CONTRACT_CREATE, api_v1_contract_createWorker)
}
function* api_v1_contract_readWorker(action) {
  try {
    const result = yield call(apiService.api_v1_contract_read, action)
    yield put(actions.api_v1_contract_readSucceeded(result, action))
  } catch (err) {
    yield put(actions.api_v1_contract_readFailed(err, action))
  }
}
function* api_v1_contract_readWatcher() {
  yield takeEvery(types.API_V1_CONTRACT_READ, api_v1_contract_readWorker)
}
function* api_v1_contract_updateWorker(action) {
  try {
    const result = yield call(apiService.api_v1_contract_update, action)
    yield put(actions.api_v1_contract_updateSucceeded(result, action))
  } catch (err) {
    yield put(actions.api_v1_contract_updateFailed(err, action))
  }
}
function* api_v1_contract_updateWatcher() {
  yield takeEvery(types.API_V1_CONTRACT_UPDATE, api_v1_contract_updateWorker)
}
function* api_v1_contract_partial_updateWorker(action) {
  try {
    const result = yield call(apiService.api_v1_contract_partial_update, action)
    yield put(actions.api_v1_contract_partial_updateSucceeded(result, action))
  } catch (err) {
    yield put(actions.api_v1_contract_partial_updateFailed(err, action))
  }
}
function* api_v1_contract_partial_updateWatcher() {
  yield takeEvery(
    types.API_V1_CONTRACT_PARTIAL_UPDATE,
    api_v1_contract_partial_updateWorker
  )
}
function* api_v1_contract_deleteWorker(action) {
  try {
    const result = yield call(apiService.api_v1_contract_delete, action)
    yield put(actions.api_v1_contract_deleteSucceeded(result, action))
  } catch (err) {
    yield put(actions.api_v1_contract_deleteFailed(err, action))
  }
}
function* api_v1_contract_deleteWatcher() {
  yield takeEvery(types.API_V1_CONTRACT_DELETE, api_v1_contract_deleteWorker)
}
...
export default function* rootSaga() {
  const sagas = [
    api_v1_contract_listWatcher,
    api_v1_contract_createWatcher,
    api_v1_contract_readWatcher,
    api_v1_contract_updateWatcher,
    api_v1_contract_partial_updateWatcher,
    api_v1_contract_deleteWatcher,

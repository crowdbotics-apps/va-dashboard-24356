...
export const api_v1_contract_list = () => ({ type: types.API_V1_CONTRACT_LIST })
export const api_v1_contract_listSucceeded = (response, starter) => ({
  type: types.API_V1_CONTRACT_LIST_SUCCEEDED,
  response,
  starter
})

export const api_v1_contract_listFailed = (response, starter) => ({
  type: types.API_V1_CONTRACT_LIST_FAILED,
  response,
  starter
})

export const api_v1_contract_create = data => ({
  type: types.API_V1_CONTRACT_CREATE,
  data
})

export const api_v1_contract_createSucceeded = (response, starter) => ({
  type: types.API_V1_CONTRACT_CREATE_SUCCEEDED,
  response,
  starter
})

export const api_v1_contract_createFailed = (response, starter) => ({
  type: types.API_V1_CONTRACT_CREATE_FAILED,
  response,
  starter
})

export const api_v1_contract_read = () => ({ type: types.API_V1_CONTRACT_READ })
export const api_v1_contract_readSucceeded = (response, starter) => ({
  type: types.API_V1_CONTRACT_READ_SUCCEEDED,
  response,
  starter
})

export const api_v1_contract_readFailed = (response, starter) => ({
  type: types.API_V1_CONTRACT_READ_FAILED,
  response,
  starter
})

export const api_v1_contract_update = data => ({
  type: types.API_V1_CONTRACT_UPDATE,
  data
})

export const api_v1_contract_updateSucceeded = (response, starter) => ({
  type: types.API_V1_CONTRACT_UPDATE_SUCCEEDED,
  response,
  starter
})

export const api_v1_contract_updateFailed = (response, starter) => ({
  type: types.API_V1_CONTRACT_UPDATE_FAILED,
  response,
  starter
})

export const api_v1_contract_partial_update = data => ({
  type: types.API_V1_CONTRACT_PARTIAL_UPDATE,
  data
})

export const api_v1_contract_partial_updateSucceeded = (response, starter) => ({
  type: types.API_V1_CONTRACT_PARTIAL_UPDATE_SUCCEEDED,
  response,
  starter
})

export const api_v1_contract_partial_updateFailed = (response, starter) => ({
  type: types.API_V1_CONTRACT_PARTIAL_UPDATE_FAILED,
  response,
  starter
})

export const api_v1_contract_delete = () => ({
  type: types.API_V1_CONTRACT_DELETE
})

export const api_v1_contract_deleteSucceeded = (response, starter) => ({
  type: types.API_V1_CONTRACT_DELETE_SUCCEEDED,
  response,
  starter
})

export const api_v1_contract_deleteFailed = (response, starter) => ({
  type: types.API_V1_CONTRACT_DELETE_FAILED,
  response,
  starter
})
